**<h1 align="center">Perpustakaan dan Kearsipan digital: Evolusi 5 hukum, Prinsip Siber, dan Keamanan data </h1>**

<p align="center"><small>Disusun Untuk Memenuhi Tugas Mata Kuliah Perpustakaan dan Kearsipan Digital
<p align="center">Dosen Pengampu : Al Muhdi Karim S.Ip, M.Hum.</p>

<p align="center"><img width="450" alt="image" src="https://github.com/user-attachments/assets/65cf5192-a199-46b4-ac35-a8d493adef07" />
</p>
<p align="center">Disusun oleh:</p>
<p align="center">Muhammad Iqbal Tamam (12402051010020)</p>
<p align="center">Bacheeta Anwar (12402051030083)</p>
<p align="center">Roihan Nabil (12402051030075)</p>
...
<p align="justify">
&nbsp;&nbsp;&nbsp;&nbsp; Hukum kedua mendorong perpustakaan untuk menyediakan koleksi yang beragam sehingga setiap anggota masyarakat dapat menemukan bahan bacaan yang sesuai dengan kebutuhannya. safii (2018) merinci cakupan hukum kedua pada era klasik, yaitu meliputi: Perpustakaan untuk semua (termasuk pria dan wanita), untuk semua anggota masyarakat, kegiatan perpustakaan untuk semua usia, serta perpustakaan untuk semua latar belakang pendidikan. Ranganathan menekankan pentingnya membangun koleksi yang inklusif dan layanan referensi yang aktif membantu setiap individu menemukan bahan yang tepat.
</p>
...
##### **2.1.2 Era Modern**
<p align="justify">
&nbsp;&nbsp;&nbsp;&nbsp; Era Modern ditandai dengan lahirnya beragam teknologi baru yang mulai mengubah wajah perpustakaan, mulai dari mesin ketik elektrik, sistem komputer mainframe, mikrofilm, hingga katalog komputer (OPAC). Para pakar ilmu perpustakaan mulai mereinterpretasikan lima hukum Ranganathan dalam konteks yang lebihh luas.
</p>
...
&nbsp;&nbsp;&nbsp;1. Confidentiality 
<p align="justify">
Confidentiality (kerahasiaan) merupakan prinsip yang mengontrol bahwa informasi dapat diakses hanya pihak-pihak tertentu yang berwenang. Prinsip ini diterapkan melalui enkripsi, MFA <i>(Multi-Factor Authentication)</i>, dan RBAC <i>(Role-Based Access Control)</i>. Dalam konteks perpustakaan prinsip ini berkaitan dengan data prinadi anggota pemustaka, riwayat peminjaman dan prefensi penelusuran bahan pustaka. Dalam buku <i>The Ethic of Cybersecurity</i> menjelaskan seringkali terdapat berbagai cara untuk mencapai tujuan yang diinginkan. Misalnya, kerahasiaan dapat dicapai dengan mengenkripsi data atau dengan kombinasi otentikasi (misalnya, dengan mewajibkan pengguna memasukan kata sandi) dan kontrol akses (aturan yang mengatur pengguna mana yang diizinkan mengakses file tertentu). 
&nbsp;&nbsp;&nbsp;Secara umum setara dengan privasi, langkah-langkah kerahasiaan dirancang untuk mencegah informasi sensitif dari upaya akses yang tidak sah. Data-data tersebut diklasifikasikan bedasarkan tingkat dan jenis kerugian yang dapat terjadi jika data tersebut jatuh ke tangan yang salah. Langkay-langkah keamanan data yang lebih atau kurang ketat kemudian dapat diterapkan sesuai dengan kategori-kategori tersebut. Perlindungan privasi dan keamanan data menjadi semakin penting dalam lingkungan perpustakaan digital yang sering kali melibatkan pertukanran informasi pribadi dan sensitif. Tantangan ini melibatkan pengembangan kebijakan privasi yang ketat, pelaksanaan teknologi keamanan yang kuat, dan pendidikan pengguna tentang praktik penggunaan yang aman dalam lingkungan digital. Perpustakaan digital harus mengambil langkah-langkah proaktif untuk melindungi privasi dan keamanan data penggunaan mereka, termasuk enkripsi data, pemantauan aktivitas dan pelaporan insiden keamanan.

&nbsp;&nbsp;&nbsp;2. Integrity
<p align="justify">
Integritas data artinya system perpustakaan dan arsip konsistensi, akurat dan keandalan data harus dijaga. Dalam prinsip integritas menjamin bahwa data dan informasi tetap utuh, tidak diubah atau dimanipulasi secara tidak sah. Prinsip integritas ini memastikan bahwa data tidak terpengaruh oleh perubahan yang tidak sah atau kehilangan integritasnya. Untuk arsip digital, integritas sangat krusial guna memastikan bahwa rekaman sejarah atau dokumen resmi tidak diubah dan tetap autentik seiring berjalannya waktu. Interitas dalam kerangka Triad CIA, tidak hanya memastikan keaslian dan keutuhan sata, tetapi juga menegakkan prinsip akuntabilitas setiap tindakan yang dilakukan oleh pengguna. Ini selaras dengan penelitian Salsabila et al.(2023) yang menekankan pentingnya penerapan audit trail dan pemantauan aktivitas pengguna untuk menjaga validitas data pada aplikasi perpustakaan digital. Demikian pula, Triandari(2022) menegaskan bahwa sistem pengawasan berlapis melalui deteksi intrusi merupakan strategis fudamental dalam menjamin keandalan serta integritas data digital.

&nbsp;&nbsp;&nbsp;3. Availability
<p align="justify">
Informasi harus dapat di akses secara konsisten dan mudah oleh pihak yang berwenang. Hal ini melibatkan pemeliharaan yang tepat terhadap perangkat keras, infrastruktur teknis, dan sistem yang menyimpan serta menampilkan informasi tersebut. Prinsip ketersediaan memastikan bahwa layanan tetap dapat diakses dan digunakan oleh pengguna dengan minimal gangguan. Perpustakaan digital harus memastikan bahwa layanan dan koleksi mereka dapat diakses oleh pengguna saat dibutuhkan, serta memiliki sistem cadangan (backup) untuk pemulihan jika terjadi kegagalan sistem atau serangan.
</p>

#### **2.4. Analisa Resiko Keamanan Perpustakaan dan Arsip Digital Berdasarkan Data Historis**
<p align="justify">
&nbsp;&nbsp;&nbsp;Perpustakaan dan arsip digital akan mengahadapi risiko keamanan yang besar karena sangat tergantung pada teknologi komputer, jaringan, komunikasi data, dan teknologi informasi lainnya. Berikut contoh kasus bedasarkan data historis.
  <ul> 
<li>Pada 2017 lalu, terjadi peretasan terhadap 700 komputer di Perpustakaan Umum St. Louis, Amerika Serikat. untuk membuka server yang diretas, Perpustakaan Umum St. Louis diminta untuk menyerahkan bitcoin kepada peretas yang ditolak oleh perpustakaan tersebut dikarenakan menurut penyelidikan FBI, mata uang bitcoin adalah mata uang online yang sulit ditelusuri keberadaannya. Alhasil, solusi yang dilakukan perpustakaan tersebut adalah menghapus keseluruhan sistem komputer yang kemudian harus dibuat ulang dengan memakan waktu yang tidak sebentar (Kean 2017). Karena informasi mengenai data diri pengguna ataupun keuangan tidak disimpan dalam server, informasi tersebut dinyatakan aman.</li> 
<li>Lalu kasus berikutnya terjadi pada <i>Toronto Public Library (TPL)</i>, yang terjadi pada tanggal 28 November 2023 lalu. Serangan ransomware menjadi penyebab gangguan layanan selama lebih dari seminggu di perpustakaan umum Toronto. Peretas mencuri sejumlah besar data pribadi staff dan berkas, termasuk nama, nomor insuran sosial dan alamat rumah mereka, serta salinan kartu identitas diri. Perpustakaan menolak membayar tebusan yang dilaporkan mencapai sepuluh juta dolar US dan memilih untuk membangun ulang seluruh infrastruktur sistem dari awal. Proses pemulihan berlansung hampir lima bulan.</li>
<li>Pada tanggal 28 Oktober 2023, <i>British Library</i> telah terkena serangan ransomware yang membahayakan sebagian besar sistem daringnya. Serangan tersebut, yang dikalim oleh ransomware Rhysida, mengekstrak data, mengenkripsi atau menghancurkan sebagian sebar server perpustakaan, dan secara paksa memblokir akses semua pengguna ke jaringan.</li> 
<li>Pada tanggal 20 Juni 2024, Indonesia digemparkan dengan insiden kebocoran data yang melibatkan Pusat Data Nasional Sementara (PDNS). Dimana pada serangan siber yang kali ini berakibat fatal pada sebagian besar sistem informasi dan instansi yang berada didalamnya. Sebanyak lebih dari 210 instansi pemerintah mengalami <i>down</i> pada layanan publik mereka terutama pada sektor imigrasi.</li> 
</ul>
<p align="justify">
&nbsp;&nbsp;&nbsp;&nbsp;Berdasarkan beberapa kasus diatas terdapat beberapa resiko yang perlu diperhatikan.
Pertama, kebocoran data menunjukan system keamanan yang lemah dapat menyebabkan data pribadi seperti nama, alamat rumah dan kartu identitas disalah gunakan. Hal ini berdampak pelanggaran privasi yang merugikan individu, penyalahgunaan data untuk kejahatan dan menurunnya kepercayaan publik terhadap layanan digital yang tersedia.
Kedua, serangan yang dialami oleh perpustakaan umum St. Louis, Toronto Public Library, British library dan Pusat Data Nasional Sementara Indonesia, semuanya terkena serangan ini. Ransomware merupakan jenis ancaman yang paling dominan dan paling merusak bagi perpustakaan dan arsip digital. Dikondisi ini data bisa terkunci atau bahkan hilang, sehingga menggangu oprasional dan layanan publik lumpuh dalam jangka waktu yang lumayan, seperti <i>Toronto Public Library</i> membutuhkan hampir lima bulan, sementara gangguan yang terjadi di PDNS Indonesia menyebabkan 210 instansi pemerintah mengalami downtime.
</p>

#### **2.5. Vektor Dasar Keamanan Siber bagi Perpustakaan atau Arsip Digital**
<p align="justify">
&nbsp;&nbsp;&nbsp;Vektor serangan (attack vector) merupakan jalur atau metode yang digunakan oleh penyerang untuk mengakses dan mengeksploitasi sistem secara tidak sah. Menurut IBM, attack vector adalah cara yang digunakan peretas untuk mendapatkan akses ke sistem atau jaringan guna menyampaikan muatan berbahaya (malicious payload) (IBM, 2026.). Dengan demikian, dalam konteks perpustakaan atau arsip digital, vektor serangan menjadi pintu masuk utama bagi berbagai ancaman siber.
<p align="justify">
&nbsp;&nbsp;&nbsp;Hal ini menjadi penting karena perpustakaan digital tidak hanya menyimpan koleksi informasi, tetapi juga data pribadi pengguna yang bersifat sensitif. Salah satu vektor yang paling umum adalah malware, yaitu perangkat lunak berbahaya yang dirancang untuk merusak sistem atau mencuri data. Sebagaimana dinyatakan bahwa “malicious software, or malware, encompasses a broad category of threats designed to infiltrate and disrupt computer systems” (Rayhan, 2024) . Dalam praktiknya, malware dapat masuk ke sistem perpustakaan melalui file unduhan atau perangkat eksternal. Sebagai contoh, komputer pengelola repositori digital yang terinfeksi ransomware dapat mengalami penguncian akses terhadap seluruh koleksi, sehingga pustakawan tidak dapat mengakses maupun memulihkan data tanpa membayar tebusan.
<p align="justify">
&nbsp;&nbsp;&nbsp;Selain itu, vektor serangan berbasis manusia seperti phishing dan social engineering juga sangat berbahaya dalam lingkungan perpustakaan digital. Teknik ini memanfaatkan kelemahan pengguna atau pustakawan dengan cara menipu agar memberikan informasi sensitif, seperti kata sandi atau data akun. Misalnya, seorang pemustaka menerima email palsu yang mengatasnamakan sistem perpustakaan dan meminta untuk melakukan login ulang melalui tautan tertentu. Tanpa disadari, data akun yang dimasukkan justru dicuri oleh penyerang. Kondisi ini menunjukkan bahwa faktor manusia menjadi salah satu titik terlemah dalam keamanan siber, sehingga diperlukan peningkatan kesadaran dan literasi digital.
<p align="justify">
&nbsp;&nbsp;&nbsp;Vektor lainnya adalah serangan Denial of Service (DoS) yang bertujuan melumpuhkan layanan perpustakaan digital dengan cara membanjiri server menggunakan trafik yang sangat besar. Dampaknya, pengguna tidak dapat mengakses katalog online (OPAC), repository institusi, atau layanan peminjaman digital. Sebagai contoh, ketika server perpustakaan universitas diserang DDoS saat masa ujian, mahasiswa tidak dapat mengakses sumber referensi yang dibutuhkan. Di samping itu, ancaman juga dapat berasal dari dalam organisasi itu sendiri, yang dikenal sebagai insider threat. Ancaman ini terjadi ketika individu yang memiliki akses resmi, seperti pustakawan atau staf IT, menyalahgunakan hak aksesnya, baik secara sengaja maupun karena kelalaian. Penelitian menunjukkan bahwa ancaman di perpustakaan digital dapat berupa pengaksesan informasi secara tidak sah, perubahan data, hingga penyalahgunaan sistem.
<p align="justify">
&nbsp;&nbsp;&nbsp;Lebih lanjut, akses ilegal atau hacking juga menjadi vektor yang signifikan, di mana pihak luar mencoba menembus sistem keamanan untuk mencuri atau merusak data. Misalnya, peretas dapat mengeksploitasi celah pada sistem repository yang tidak diperbarui, sehingga berhasil masuk dan menghapus atau memodifikasi koleksi digital. Selain itu, serangan melalui jaringan seperti man-in-the-middle memungkinkan penyerang menyadap komunikasi antara pengguna dan sistem perpustakaan, terutama jika menggunakan jaringan publik yang tidak aman. Seluruh vektor serangan tersebut pada akhirnya dapat mengganggu tiga aspek utama keamanan informasi, yaitu kerahasiaan (confidentiality), integritas (integrity), dan ketersediaan (availability). Oleh karena itu, perpustakaan atau arsip digital perlu menerapkan sistem keamanan yang komprehensif, baik dari sisi teknologi maupun sumber daya manusia, guna meminimalisir risiko serangan siber.
</p>

#### **2.6. Faktor yang Harus Dikembangkan dan Ditingkatkan dalam Perpustakaan dan Arsip Digital**
<p align="justify">
&nbsp;&nbsp;&nbsp;Untuk meningkatkan keamanan siber pada perpustakaan dan arsip digital, terdapat beberapa faktor penting yang perlu dikembangkan secara berkelanjutan. Pertama, peningkatan kualitas sumber daya manusia (SDM) menjadi hal utama, khususnya melalui pelatihan dan peningkatan kesadaran terhadap ancaman keamanan informasi. Hal ini sesuai dengan pernyataan bahwa perlu adanya “peningkatan kinerja pustakawan atau pun pihak pengelola lainnya dengan diikutkan berbagai pelatihan” (Triandari, 2022).
<p align="justify">
&nbsp;&nbsp;&nbsp;Kedua, pembaruan sistem dan perangkat teknologi secara rutin juga diperlukan agar sistem tidak mudah mengalami gangguan atau serangan. Selain itu, penerapan backup data secara berkala menjadi langkah penting dalam menjaga keamanan informasi, karena “cara paling mudah agar suatu informasi yang disimpan tetap aman adalah dengan back up” (Triandari, 2022).
<p align="justify">
&nbsp;&nbsp;&nbsp;Perpustakaan juga perlu mengembangkan infrastruktur keamanan seperti enkripsi dan keamanan jaringan sebagai bagian dari strategi pertahanan berlapis. Dalam hal ini dijelaskan bahwa cybersecurity mencakup “implementation of technologies, processes, and policies to safeguard information assets” (Rayhan, 2024.) . Selain itu, IBM juga menekankan bahwa pemahaman terhadap berbagai jalur serangan (attack vectors) sangat penting agar organisasi dapat mengidentifikasi dan menutup celah keamanan sejak dini (IBM, 2026.). Dengan demikian, penguatan SDM, teknologi, serta manajemen keamanan secara menyeluruh akan membantu perpustakaan digital dalam menghadapi berbagai ancaman siber secara lebih efektif dan berkelanjutan.
</p>
